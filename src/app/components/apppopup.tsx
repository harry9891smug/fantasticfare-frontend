...
const handleGoogleLogin = () => {
  const googleClientId =
    "341176353179-v8a3fikhpq8kafolh11upjgbisf8ro55.apps.googleusercontent.com";
  const redirectUri =
          ...
          {showForgotPassword ? (
            ...
            <>
              ...
              <p className={styles.greyText}>
                {isLogin
                  ? "Login with Email"
                  : "Sign up and let your travel dreams take flight"}
              </p>
              ...
              <form className={styles.authForm} onSubmit={handleSubmit}>
                ...
                <div
                  className={`${styles.inputGroup} ${
                    invalidFields.includes("email") ? styles.inputError : ""
                  }`}
                >
                  ...
                  <div className={styles.phoneContainer}>
                    <input
                      ...
                      className={`${styles.countryCode} ${
                        invalidFields.includes("phone") ? styles.inputError : ""
                      }`}
                      name="countryCode"
                ...
                <div
                  className={`${styles.inputGroup} ${
                    invalidFields.includes("password") ? styles.inputError : ""
                  }`}
                >
