    ...
    const fetchCountries = async () => {
      try {
        const response = await axios.get(
          `${process.env.NEXT_PUBLIC_BACKEND_URL}/display-countries`
        );
        ...
        const existingTitles = dynamicDestinations.map((item) =>
        ...
        const combined = [
          ...dynamicDestinations,
          ...filteredStatic.slice(0, 9 - dynamicDestinations.length),
        ];
      ...
      <div className="footer-background">
          ...
          <div className="background-border-shadow">
            ...
            <div className="social-media">
              <ul>
                <li>
                  <a
                    href="https://www.facebook.com/fantasticfare"
                    target="_blank"
                ...
                <li>
                  <a
                    href="https://x.com/fantasticfare"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <svg
                    ...
                    >
                      <path
                        d="M16.033 0C7.169 0 0 7.169 0 16.033C0 24.897 7.169 32.066 16.033 32.066C24.897 32.066 32.066 24.897 32.066 16.033C32.001 7.169 24.832 0 16.033 0ZM24.5 8.5L18.5 16L24.5 23.5H21.5L16 17.5L10.5 23.5H7.5L13.5 16L7.5 8.5H10.5L16 14.5L21.5 8.5H24.5Z"
                        fill="#B7B7B7"
                      />
                    </svg>
                  </a>
                ...
                <li>
                  <a
                    href="https://www.instagram.com/fantasticfare/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Image
                ...
                <li>
                  <a
                    href="https://www.youtube.com/@FantasticFare"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
          ...
          <div className="background-border-shadow-1">
            <div className="gallery">
              {finalDestinations.map((item, index) => (
                <div className="gallery-item" key={index}>
                  <a
                    href={`/country/${slugify(item.slug)}`}
                    rel="noopener noreferrer"
                  >
                    <Image
                      src={item.src}
        ...
        <div className="footer-logo-copyright">
          ...
          <div className="footer-copyright">
            <p>
              The content and images on this website are protected by copyright,
              with all rights belonging to their respective owners. They are
              used solely to promote their works, <br /> with no intent to imply
              endorsement of the artists. Any unauthorized use is strictly
