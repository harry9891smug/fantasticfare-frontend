      ...
      const fallback = [
        {
          ...
          article_description:
            "Keep a copy of your passport and know emergency contacts.",
        ...
        <div className="col-12 col-md-4 mb-4 mb-md-0">
          <div className="scrollable-tips">
            {articles.map((article) => (
              <div
                key={article._id}
                className={`article-box p-3 mb-3 ${
                  article?._id === article._id ? "active" : ""
                }`}
              ...
              >
                ...
                <Link
                  ...
                  href={`/tips-and-article/${article.article_slug}`}
                >
                  {" "}
                  <button className="btn-color btn btn-primary btn-sm custom-btn">
                    Read More
                  </button>
                </Link>
              </div>
            ...
            <div className="article-image-box">
              ...
              <div className="p-3">
                ...
                <p className="article-description">
                  {he
                    .decode(
                      (selectedArticle?.article_description || "").replace(
                        /<[^>]*>/g,
                        ""
                      )
                    )
                ...
                <Link
                  className="title-links"
                  href={`/tips-and-article/${selectedArticle._id}`}
                >
                  {" "}
                  <button className="btn-color btn btn-primary custom-btn">
                    Read More
                  </button>
                </Link>
              </div>
